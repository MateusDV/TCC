...
GO
CREATE TABLE PROVA (
	ID_PROVA      INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
...
GO
CREATE TABLE NOTA (
	ID_ATIV     INT FOREIGN KEY REFERENCES PROVA(ID_PROVA),
	ID_ALUNO    INT FOREIGN KEY REFERENCES ALUNO(ID_ALUNO),
...
GO
INSERT INTO FUNCIONARIO VALUES('TESTE', 'TESTE', 'TESTE', 'TESTE', 'TESTE', 1, 'TESTE', 'TESTE', 'TESTE', 'TESTE', 'TESTE', 'TESTE', 'testet', 'teste', 1, DEFAULT)
GO
select* from cargo
