...
CREATE TABLE FUNCIONARIO (
	...
	EMAIL          VARCHAR(80) NOT NULL,
	SENHA          VARCHAR(80) NOT NULL,
	CARGO          FOREIGN KEY REFERENCES CARGO(ID_CARGO),
	CADASTRO       DATE DEFAULT GETDATE()
)
GO
...
CREATE TABLE CARGO (
	...
	NOME       VARCHAR(50) NOT NULL,
	ATIV_CRIAR BOOLEAN NOT NULL,
	ATIV_EDIT  BOOLEAN NOT NULL,
	ATIV_CONS  BOOLEAN NOT NULL,
	NOTA_ATRIB BOOLEAN NOT NULL,
	NOTA_CONS  BOOLEAN NOT NULL,
	ALUNO_CADS BOOLEAN NOT NULL,
	ALUNO_CONS BOOLEAN NOT NULL,
	ALUNO_EDIT BOOLEAN NOT NULL,
	FUNC_CADS  BOOLEAN NOT NULL,
	FUNC_CONS  BOOLEAN NOT NULL,
	FUNC_EDIT  BOOLEAN NOT NULL,
	PROF_CADS  BOOLEAN NOT NULL,
	PROF_CONS  BOOLEAN NOT NULL,
	PROF_EDIT  BOOLEAN NOT NULL	
)
